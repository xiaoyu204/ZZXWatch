...
#define i2c_write(dev_addr, reg_addr, data_size, p_data) \
    HAL_I2C_Mem_Write(&hi2c3, dev_addr, reg_addr, I2C_MEMADD_SIZE_8BIT, p_data, data_size, 0x100)
#define i2c_read(dev_addr, reg_addr, data_size, p_data) \
    HAL_I2C_Mem_Read(&hi2c3, dev_addr, reg_addr, I2C_MEMADD_SIZE_8BIT, p_data, data_size, 0x100)
